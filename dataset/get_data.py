...
from dataset.synthetic import SignalDataset
...
def get_dataset(seq_len=1024):
    ...
    synthetic = SignalDataset(seq_len=seq_len, size=200_000)
    ...
    mixup_6 = InnerMixUP(synthetic, K=3, alpha=1.5, n_samples=200_000)
    mixup_7 = InterMixup(
        [synthetic, gift_pretrain], K=3, alpha=1.5, n_samples=200_000
    )
    return torch.utils.data.ConcatDataset([art_trainset, synthetic, boom, gift_pretrain, kernel_synth, mixup, mixup_1, mixup_2, mixup_3, mixup_5, mixup_6, mixup_7])
...
def get_dataset_leakage(seq_len=1024):
    ...
    mixup_10 = InnerMixUP(synthetic, K=3, alpha=1.5, n_samples=200_000)
    mixup_11 = InterMixup(
        [synthetic, gift_pretrain], K=3, alpha=1.5, n_samples=200_000
    )
    mixup_12 = InterMixup([synthetic, gift_eval], K=3, alpha=1.5, n_samples=200_000)
    return torch.utils.data.ConcatDataset([art_trainset, synthetic, gift_pretrain, gift_eval, boom, kernel_synth, mixup, mixup_1, mixup_2, mixup_3, mixup_5, mixup_6, mixup_7, mixup_8, mixup_9, mixup_10, mixup_11, mixup_12])